<h1 align="center"> Sentiment Analysis on Comments About Mobile JKN Using Naïve Bayes Algorithm</h1>

## Description

This project is a Sentiment Analysis on Comments About Mobile JKN Using Naïve Bayes Algorithm.

### About the dataset:

The dataset we use is tweet data about the JKN application which is taken 30 data.
...
```
git clone https://github.com/dunasi4139/JKN-Sentiment-Analysis-Manual-with-Naive-Bayes-Algorithm.git
```
